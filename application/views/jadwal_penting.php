    ...
    <div class="row mb-3">
         <div class="col-xl-12 col-md-6 mb-4">
            <div class="card h-100">
                <br>
                <form class="form-horizontal" action="<?=base_url()?>jadwal_penting/proses_add" method="POST" role="form">

                  <div class="form-group">
                    <label class="control-label col-sm-2" for="email">Keterangan : </label>
                    <div class="col-sm-4">
                      <textarea class="form-control" name="keterangan" rows="3" placeholder="tulis keterangan"></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="email">Jadwal :</label>
                      <div class="col-sm-4">
                         <input type="text" class="form-control" name="tgl_jadwal" placeholder="tulis jadwal penting" require>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="email">Urutan :</label>
                      <div class="col-sm-4">
                         <input type="text" class="form-control" name="urutan" placeholder="ex : 1 " require>
                      </div>
                  </div>
