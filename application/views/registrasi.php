			...
			<div class="row justify-content-center">
              ...
              <?php echo $this->session->flashdata('pesan')?>
                ...
                <div class="form-group mt-3">
			      			...
			      			<label class="form-control-placeholder" name="nama_lengkap">Nama Lengkap</label>
			      		</div>
                <div class="form-group mt-3">
			      			<input type="text" name="email" class="form-control" required>
			      			<label class="form-control-placeholder" name="email">Email</label>
			      		</div>
                ...
                <div class="form-group">
		          ...
		          <p class="text-center">sudah memiliki akun ? <a data-toggle="tab" href="#signup">Login</a></p>
		        </div>
		      </div>
				</div>
			</div>
